    ...
    <div class="content-wrapper">
      <div class="list-wraper">
        <div :key="item.id"
             ...
             class="image-wrapper">
          <img :src="item.url" />
          <i @click="handleAdd(item.url)"
             class="pt-iconfont icon-plus-circle"></i>
        </div>
      </div>
      ...
      <div class="tool-wrapper">
        <i @click="handleDelete"
           class="pt-iconfont icon-delete">删除</i>
        <i @click="rotate"
           class="pt-iconfont icon-shuaxin">旋转</i>
        <i @click="upd"
           class="pt-iconfont icon-crop">提高层级</i>
        <i @click="onSave"
           class="pt-iconfont icon-crop">生成图片</i>
        <button @click="line">画线</button>
        <button @click="circle">画圆</button>
        <button @click="test">测试</button>
      </div>
    </div>
    <vue-image-model :close="()=>{imgUrl=''}"
...
export default {
  ...
  data() {
    return {
      ...
      list: [
        ...
        {
          id: 4,
          url: './image/sticker4.png'
        },
        {
          id: 5,
          url: './image/sticker5.png'
        }
      ],
      isDrawingMode: true
    }
  ...
  mounted() {
    ...
    //     this.$refs.canvas.createImage('./image/sticker1.png', { id: 'myImage', width: 100, height: 100, left: 10, top: 10 ,evented:false, selectable: false});
    //     // this.$refs.canvas.createImage('./image/sticker2.png');
    //     // this.$refs.canvas.createImage('./image/sticker3.png');
    //     let options = {
    ...
    //     this.$refs.canvas.setCornerIcons({ size: 20, tl: './image/cow.png' });
  ...
  methods: {
    ...
    // 线
    line() {
      this.$refs.canvas.drawArrowLine()
    },
    changeDrawMore() {
